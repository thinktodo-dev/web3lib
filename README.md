...
[![pub package](https://img.shields.io/pub/v/web3lib.svg)](https://pub.dartlang.org/packages/web3lib)
...
If you want to integrate `web3lib` with other wallet providers, you can implement
...
listen for events emitted by smart contracts. See [this file](https://github.com/thinktodo-dev/web3lib/blob/development/example/contracts.dart)
for an example.

### Dart Code Generator

By using [Dart's build system](https://github.com/dart-lang/build/), web3lib can
...
[tracker]: https://github.com/thinktodo-dev/web3lib/issues/new
