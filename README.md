...
listen for events emitted by smart contracts. See [this file](https://github.com/simolus3/web3lib/blob/development/example/contracts.dart)
for an example.
...
[tracker]: https://github.com/simolus3/web3lib/issues/new
